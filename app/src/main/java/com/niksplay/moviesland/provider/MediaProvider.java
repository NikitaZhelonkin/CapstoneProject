...
import com.niksplay.moviesland.provider.base.BaseContentProvider;
...
public class MediaProvider extends BaseContentProvider {
    ...
    public static final String AUTHORITY = "com.niksplay.moviesland.provider";
    public static final String CONTENT_URI_BASE = "content://" + AUTHORITY;

    private static final int URI_TYPE_FAVORITE = 0;
    private static final int URI_TYPE_FAVORITE_ID = 1;

    private static final int URI_TYPE_WATCHLIST = 2;
    private static final int URI_TYPE_WATCHLIST_ID = 3;
    ...
    static {
        ...
        URI_MATCHER.addURI(AUTHORITY, WatchlistColumns.TABLE_NAME, URI_TYPE_WATCHLIST);
        URI_MATCHER.addURI(AUTHORITY, WatchlistColumns.TABLE_NAME + "/#", URI_TYPE_WATCHLIST_ID);
    }

    @Override
    protected SQLiteOpenHelper createSqLiteOpenHelper() {
        return SQLiteHelper.getInstance(getContext());
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            case URI_TYPE_WATCHLIST:
                return TYPE_CURSOR_DIR + WatchlistColumns.TABLE_NAME;
            case URI_TYPE_WATCHLIST_ID:
                return TYPE_CURSOR_ITEM + WatchlistColumns.TABLE_NAME;
    ...
    protected QueryParams getQueryParams(Uri uri, String selection, String[] projection) {
        ...
        switch (matchedId) {
            ...
            case URI_TYPE_WATCHLIST:
            case URI_TYPE_WATCHLIST_ID:
                res.table = WatchlistColumns.TABLE_NAME;
                res.idColumn = WatchlistColumns._ID;
                res.tablesWithJoins = WatchlistColumns.TABLE_NAME;
                res.orderBy = WatchlistColumns.DEFAULT_ORDER;
                break;
